// Deconvolution.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDeconvolutionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CDeconvolutionApp

CDeconvolutionApp::CDeconvolutionApp()
{
...
// Единственный объект CDeconvolutionApp

CDeconvolutionApp theApp;


// инициализация CDeconvolutionApp

BOOL CDeconvolutionApp::InitInstance()
{
